...
O GitHub Repositories é uma LandingPage do segundo projeto react, GoStack da RocketSeat. Este projeto trata-se do consumo API do GitHub.
...
### Tela de Adição de Repositórios

<p align="center">
  <img alt="NextLevelWeek" title="#NextLevelWeek" src="./assets/banner.png" width="200px">

  <img alt="NextLevelWeek" title="#NextLevelWeek" src="./assets/banner.png" width="200px">
</p>

### Tela de Listagem de Repositórios

<p align="center" style="display: flex; align-items: flex-start; justify-content: center;">
  <img alt="NextLevelWeek" title="#NextLevelWeek" src="./assets/banner.png" width="400px">
